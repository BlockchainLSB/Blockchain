...
router.get('/', function(req, res, next){
   ...
   query_portfolio(api_token, api_port, 'searchPortfolio', ['userid', search_id], function(data, statusCode){
      var result = data;
      var code = statusCode;
      var jportfolio = JSON.parse(result);
      
      query_portfolio(api_token, api_port, 'searchProject', ['userid', search_id], function(data, statusCode){
      var result = data;
      var code = statusCode; 
